...
Purpose:
    This stored procedure loads data from the Bronze layer
    into the Silver layer.

    During this process, the data is cleaned, standardized,
    and transformed before being stored in the Silver tables.

    The procedure performs the following steps:
    - Clears existing data from the Silver tables.
    - Reads raw data from the Bronze layer.
    - Applies data cleaning and transformation rules.
    - Loads the processed data into the Silver layer.
